...
class LoginFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val viewFragment = inflater.inflate(R.layout.login_fragment, container, false)




        val log = viewFragment.findViewById(R.id.button_login_form) as MaterialButton
        log.setOnClickListener { view ->
            Navigation.findNavController(view).navigate(R.id.action_button_login_form_to_albumsFragment)
